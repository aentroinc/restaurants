        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            {(["all","pending","approved","in-progress","completed"] as const).map((key) => (
              ...
              >
                <div className="kpi-value text-xl text-white/80">{counts[key]}</div>
                        ...
                        {action.status === "pending" && (
                          <div className="flex gap-2 pt-2 border-t border-white/[0.06]">
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2 rounded bg-emerald-500/20 text-emerald-400 text-[11px] font-medium hover:bg-emerald-500/30 transition-colors"
                            >
                              <CheckCircle className="w-3.5 h-3.5" /> 承認
                            </button>
                            <button
                              onClick={() => handleReject(action.action_id)}
                              className="flex items-center gap-2 px-4 py-2 rounded bg-red-500/10 text-red-400 text-[11px] font-medium hover:bg-red-500/20 transition-colors"
                            >
                              <XCircle className="w-3.5 h-3.5" /> 却下
                            </button>
                            <button className="flex items-center gap-2 px-4 py-2 rounded bg-white/[0.04] text-white/40 text-[11px] hover:bg-white/[0.06] transition-colors ml-auto">
                              <FileText className="w-3.5 h-3.5" /> 修正して承認
                            </button>
                          </div>
                        )}
                      </div>
