...
from sqlalchemy import Date, Numeric, ForeignKey, DateTime, UniqueConstraint, func
...
class LaborActual(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tenant_id", "store_id", "business_date", name="uq_labor_store_date"),
    )
