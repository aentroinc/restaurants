            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="grid gap-4 py-4">
                <div>
                  ...
                  <Input placeholder="タスクのタイトル" className="mt-1" />
                </div>
                <div>
                  <label className="text-sm font-medium">店舗</label>
                  <Select><SelectTrigger className="mt-1"><SelectValue placeholder="店舗を選択" /></SelectTrigger>
                    <SelectContent>{/* populated from stores */}</SelectContent>
                  </Select>
                </div>
                <div>
                  <label className="text-sm font-medium">詳細</label>
                  <Textarea placeholder="タスクの詳細を記載" className="mt-1" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium">課題種別</label>
                    <Select><SelectTrigger className="mt-1"><SelectValue placeholder="種別" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <Select><SelectTrigger className="mt-1"><SelectValue placeholder="優先度" /></SelectTrigger>
                      <SelectContent>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input placeholder="担当者名" className="mt-1" />
                  </div>
                  <div>
              ...
              <DialogFooter>
                ...
                <Button onClick={() => setDialogOpen(false)}>作成</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        }
